...
company_list_names = companies.keys()
...
for list_name in company_list_names:
    company_filing_lists[list_name] = []
    global_filing_list[list_name] = []
    for company in companies[list_name]:
        ...
        global_filing_list_adder = GlobalFilingListAdder(company, global_filing_list[list_name])
        ...
        company_filing_lists[list_name].append({
            'company': company,
...
output = template.render(company_list_names = company_list_names, company_filing_lists = company_filing_lists, global_filing_list=global_filing_list)
